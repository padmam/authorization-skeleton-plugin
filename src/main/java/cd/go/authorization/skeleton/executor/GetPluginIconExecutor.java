...
import cd.go.authorization.skeleton.util.Util;
...
public class GetPluginIconExecutor implements RequestExecutor {
    ...
    public GoPluginApiResponse execute() throws Exception {
        ...
        jsonObject.addProperty("data", Base64.encodeBase64String(Util.readResourceBytes("/" + iconName())));
        DefaultGoPluginApiResponse defaultGoPluginApiResponse = new DefaultGoPluginApiResponse(200, GSON.toJson(jsonObject));
        return defaultGoPluginApiResponse;
    }

    //TODO: provide your icon name instead of "gocd_72_72_icon.png"
